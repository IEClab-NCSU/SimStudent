...
silex.controller.FileMenuController.prototype.newFile = function(opt_cbk, opt_errorCbk) {
  ...
  if (this.isDirty())
  {
	goAhead = confirm('You have unsaved changes that will be lost if you open a new file.  Continue?')
	if (!goAhead)
	{	  
		if (opt_cbk)
		{
...
silex.controller.FileMenuController.prototype.openFile = function(opt_cbk, opt_errorCbk) {
  ...
  if (this.isDirty())
  {
	goAhead = confirm('You have unsaved changes that will be lost if you open another file.  Continue?');
	if (!goAhead)
	{
		if (opt_cbk)
		{
