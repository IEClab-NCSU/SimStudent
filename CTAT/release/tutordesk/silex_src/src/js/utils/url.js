...
/**
*	Generates a blob from raw data and creates a URL to ref it
*	@param blobData the raw data
*	@param optType optional filetype 
*/
silex.utils.Url.genBlobUrl = function(blobData, optType)
{
	var typeArg = optType ? {type: optType} : null;
	let blob = typeArg ? new Blob([blobData], typeArg) : new Blob([blobData]);
