/**-----------------------------------------------------------------------------
 ...
 $HeadURL: svn://pact-cvs.pact.cs.cmu.edu/usr5/local/svnroot/AuthoringTools/branches/CTAT_4_2_Release/HTML5/src/CTATComponents/CTATAudioButtonImaged.js $
 $Revision: 23782 $
...
CTATAudioButtonImaged = function(aDescription,aX,aY,aWidth,aHeight)
{
	...
	var soundFile="";
	this.setParameterHandler("SoundFile",function(aUrl){ soundFile=aUrl; });
	...
	this.assignImages (CTATAudioButtonImaged.audioDefaultImage,
					   CTATAudioButtonImaged.audioHoverImage,
					   CTATAudioButtonImaged.audioClickedImage,
					   CTATAudioButtonImaged.audioDisabledImage);
	...
	this.init=function init()
	{
		...
		var bgColor="#ffffff";//pointer.getBackgroundColor();
...
CTATAudioButtonImaged.prototype = Object.create(CTATImageButton.prototype);
