/**-----------------------------------------------------------------------------
 ...
 $HeadURL: svn://pact-cvs.pact.cs.cmu.edu/usr5/local/svnroot/AuthoringTools/branches/CTAT_4_2_Release/HTML5/src/CTATComponents/CTATPlayButton.js $
 $Revision: 23157 $
...
CTATPlayButton = function()
{
	...
	function playTutor()
	{
		...
		getSafeElementById(ctatcontainer).removeChild(playDiv);
		initTutor ();
	}

	function init()
	{
		//var mainCanvas=checkTutorCanvas ();
		var mainCanvas=getSafeElementById(ctatcontainer);
