...
if (typeof Iterator === 'undefined') {
  Iterator = function (o) {
    ...
    if (Array.isArray(o))
      while (keys.length < o.length) keys.push(o[keys.length]);
    else
      for (var p in o) if (o.hasOwnProperty(p)) keys.push(p);

    this.next = function () {
      return (index < keys.length) ? {value: keys[index++], done: false} : {value: void 0, done: true};
    };
  };
...
if (typeof Map !== 'undefined' && !Map.prototype.keys) {
  Map.prototype.keys = function () {
    var result = [];
    this.forEach(function (v, k) { result.push(k); });
...
if (typeof Map !== 'undefined' && !Map.prototype.values) {
  Map.prototype.values = function () {
    var result = [];
    this.forEach(function (v, k) { result.push(v); });
    return new Iterator(result);
  };
}
...
if (typeof Map !== 'undefined' && !Map.prototype.entries) {
  Map.prototype.entries = function () {
    var result = [];
    this.forEach(function (v, k) { result.push([k, v]); });
    return new Iterator(result);
  };
}

if (typeof Set !== 'undefined' && !Set.prototype.keys) {
...
if (typeof Set !== 'undefined' && !Set.prototype.values) {
...
if (typeof Set !== 'undefined' && !Set.prototype.entries) {
  Set.prototype.entries = function () {
    var result = [];
    this.forEach(function (e) { result.push([e, e]); });
    return new Iterator(result);
  };
}
