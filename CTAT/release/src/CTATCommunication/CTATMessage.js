/**-----------------------------------------------------------------------------
 ...
 $HeadURL: svn://pact-cvs.pact.cs.cmu.edu/usr5/local/svnroot/AuthoringTools/branches/CTAT_4_2_Release/HTML5/src/CTATCommunication/CTATMessage.js $
 $Revision: 24364 $
...
CTATMessage = function(aMessage)
{
	...
	*/
	...
	/**
	 * Parse the custom_fields element into an array whose indices are the
	 * field names.
