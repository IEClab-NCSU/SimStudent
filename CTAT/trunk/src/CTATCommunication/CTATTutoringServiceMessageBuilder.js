/**-----------------------------------------------------------------------------
 $Author: sewall $
 $Date: 2017-03-13 22:55:14 -0500 (週一, 13 三月 2017) $
	...
	this.createSetPreferencesMessage=function createSetPreferencesMessage (versionNum)
	{
		...
		switch (logMethod)
		{
			...
			case "ServiceToDiskAndLogServer":
				...
				logDisk = true;
				break;
			case "ClientToLogServer":  // directly to OLI Logging Server (DataShop)
				logRemote = false;
				logDisk = false;
				break;
			case "ClientToService":    // via Tutoring Service to OLI Server
				logRemote = true;
				logDisk = true;
				break;
			default:
