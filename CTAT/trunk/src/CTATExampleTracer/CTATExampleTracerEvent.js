...
/**************************** PRIVATE INSTACE VARIABLES ******************************************************/
	...
	/**
	 * Rules associated with the evaluation.  Only relevant when rule-tracing
	 */
	var associatedRules = [];
	
	/**
	 * Skills associated with the evaluation.  Only relevant when rule-tracing
	 */
...
/***************************** PRIVILEDGED METHODS *****************************************************/
	...
	/**
	 * @return {boolean} true if result is CTATExampleTracerLink.BUGGY_ACTION or CTATExampleTracerLink.FIREABLE_BUGGY_ACTION
	 */
