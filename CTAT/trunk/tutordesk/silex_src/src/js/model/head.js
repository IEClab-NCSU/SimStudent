...
/**
*	Set the contents of the 'silex-temp-styles' tag
*	@param the new innerHTML of the tag
*/
silex.model.Head.prototype.setTempStyle = function(cssString)
{
	var tempStyles = goog.dom.getElementByClass('silex-temp-styles', this.getHeadElement());
	if (!tempStyles)
	{
		tempStyles = goog.dom.createElement('style');
		tempStyles.type = 'text/css';
		tempStyles.className = 'silex-temp-styles';
		goog.dom.appendChild(this.getHeadElement(), tempStyles);
	}
	tempStyles.innerHTML = cssString;
};

/**
*	Add a style declaration to the 'silex-temp-styles' tag
*	@param newStyle the declaration to add
*/
silex.model.Head.prototype.addTempStyle = function(newStyle)
{
	var tempStyles = goog.dom.getElementByClass('silex-temp-styles', this.getHeadElement());
	if (!tempStyles)
	{
...
/**
*	Get the contents of the 'silex-temp-styles' tag
*/
silex.model.Head.prototype.getTempStyle = function()
{
	var tempStyles = goog.dom.getElementByClass('silex-temp-styles', this.getHeadElement());
	return tempStyles ? tempStyles.innerHTML : '';
};

/**
*	Remove a style declaration from the 'silex-temp-styles' tag
*	@param toRemove the declaration to remove
*/
silex.model.Head.prototype.removeTempStyle = function(toRemove)
{
	var tempStyles = goog.dom.getElementByClass('silex-temp-styles', this.getHeadElement());
	if (tempStyles)
	{	
		tempStyles.innerHTML = tempStyles.innerHTML.replace(toRemove, '');
	}
}
