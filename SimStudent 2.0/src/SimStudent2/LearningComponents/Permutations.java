...
/**
 * The Permutations class provides an enumeration of all permutations
 * of an array of objects. Each permutation is simply an ordered list
 * of the group.
 * <p>
 * For example, to see all of the ways we can select a school
 * representative and an alternate from a list of 4 children, begin
 ...
 * </pre></blockquote>
 *
 * To see all 2-permutations of these 4 names, create and use a
...
public class Permutations implements java.util.Enumeration {
    ...
    /**
     * @return java.lang.Object, the next permutation of the original
     * Object array.
     * <p>
