...
/**
 * The object that stores a registry of available components and maps
...
Object.defineProperty(CTAT.ComponentRegistry, 'addComponentType', {
	enumerable: false,
	/**
	 * Adds an interface description message component type to the registry.
	 ...
	 */
	value: function (aName,aConstructor) {
