...
/***************************** PRIVATE METHODS *****************************************************/
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in internalRemoveLinkFromGroupRecursive");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in internalRemoveLinkFromGroup");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in internalAddLinkToGroup");
		grp.addLink(link);
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getImmediateGroupOfLink");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getNaturalContainingGroup");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in addSubgroupPreserveSanity parent: " + parent.getName());
		that.ctatdebug("CTATDefaultGroupModel --> in addSubgroupPreserveSanity child: " + child.getName());
		that.ctatdebug("CTATDefaultGroupModel --> in addSubgroupPreserveSanity size: " + that.getGroupSubgroups(parent).size);
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in addSubgroup");
...
/***************************** PRIVILEDGED METHODS *****************************************************/
	...
	this.clear = function()
	{
		that.ctatdebug("CTATDefaultGroupModel --> in clear");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in setDefaultReenterable");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in setGroupOrdered");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in setGroupName");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in addLinkToGroup");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in isGroupOrdered group name: " + grp.getName());
		that.ctatdebug("CTATDefaultGroupModel --> in isGroupOrdered: " + grp.getIsOrdered());
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in isGroupReenterable");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in isLinkInGroup");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getGroupsContainingLink(" + link + "): TopLevel " + TopLevel + ", typeof(TopLevel) " + typeof(TopLevel));

		var groups = new Set(); //of CTATLinkGroup

		var groupIter = new CTATGroupIterator(TopLevel);

		that.ctatdebug("CTATDefaultGroupModel --> in getGroupsContainingLink before loop: groupIter " + groupIter + ", typeof(groupIter) " + typeof(groupIter));
		...
		that.ctatdebug("CTATDefaultGroupModel --> in getGroupsContainingLink returning groups.size " + groups.size);
		return groups;
	};
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getLowestLevelGroupOfLink");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getGroupSubgroups");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getUniqueLinks");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getGroupLinks: " + grp.getName());
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in removeLinkFromGroup");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getGroupParent");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in addGroup");
		...
		that.ctatdebug("CTATDefaultGroupModel --> in addGroup after creating new group");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in setGroupReenterable");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in createIdToLinkMap");
	...
	{
		that.ctatdebug("CTATDefaultGroupModel --> in getGroupByName TopLevel has: " + TopLevel.getSubgroups().size);
