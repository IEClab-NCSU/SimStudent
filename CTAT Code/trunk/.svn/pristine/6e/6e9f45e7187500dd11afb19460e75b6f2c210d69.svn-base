...
CTATTransactionListener = function(transactionURL)
{
	...
	default:
	    return true;  // return true for tutor responses
	}
    };
     ...
     * @param {CTATMessage} msg
     * @return {<object>} each element a formatted skill; can be empty
     */
     ...
     * @param {CTATMessage} msg
     * @return {Array<object>} each element a formatted skill; can be empty
     */
    ...
    /**
     * Retrieve a property value from a message and return it as an array of strings. If the value
     * is an array of &lt;value&gt; elements, then the elements of the returned array will match
     * the value elements.
     * @param {string} msg either an XML (or JSON?) string
     * @param {string} propName element name
     * @return {Array<string>} value of the named element as array; empty array [] if propName not found
     */
