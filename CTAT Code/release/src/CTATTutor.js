/**-----------------------------------------------------------------------------
 $Author: mdb91 $
 $Date: 2017-01-10 17:38:23 -0600 (週二, 10 一月 2017) $
 $Header$
 $Name$
 $Locker$
 $Log$
...
CTATTutor.initTutor = function(aFlashVars,aDiv,aCanvas,usingFlash) // Main entry point
{
	...
	if(CTATConfiguration.get("show_debug_traces") == "true")  // turn on debug tracing set by environment--TutorShop, e.g.
	{
		useDebuggingBasic = true;  // useDebugging too processor-heavy
	}
