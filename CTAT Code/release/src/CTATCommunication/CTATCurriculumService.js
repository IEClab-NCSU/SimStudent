/**-----------------------------------------------------------------------------
 ...
 $HeadURL: svn://pact-cvs.pact.cs.cmu.edu/usr5/local/svnroot/AuthoringTools/branches/CTAT_4_2_Release/HTML5/src/CTATCommunication/CTATCurriculumService.js $
 $Revision: 23157 $
...
//			this.addVariable ('problem_state',""); This will come later
		...
		else
		{
			if (complete=="complete")
			{
				CTATScrim.scrim.scrimUp ("Congratulations, you are done with this problem.");
			}
		}
	};
