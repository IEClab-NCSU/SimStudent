/**-----------------------------------------------------------------------------
 ...
 $HeadURL: svn://pact-cvs.pact.cs.cmu.edu/usr5/local/svnroot/AuthoringTools/branches/CTAT_4_2_Release/HTML5/src/CTATComponents/CTATCheckBox.js $
 $Revision: 24393 $
...
CTATCheckBox = function(aDescription,aX,aY,aWidth,aHeight)
{
	...
	this.UpdateCheckBox = function (aLabel) {
		...
		var search_string = new RegExp("(^|;)"+CTATCheckBox.escape(label.innerHTML)+"\\s*:\\s*true");
