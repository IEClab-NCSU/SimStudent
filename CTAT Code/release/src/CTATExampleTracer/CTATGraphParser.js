...
CTATGraphParser = function()
{
        ...
        for (var index = 0; index < children.length; index++)
        {
            ...
            if (parser.getElementName(children[index]) === "actionLabel")
            {
                ...
                for (var jndex = 0; jndex < actionLabelChildren.length; jndex++)
                {
                    ...
                    {
                        var legacyMatchers = processMatcher(actionLabelChildren[jndex]);
     ...
     */
    function processMatcher(element)
    {
		...
		// console.log("processMatcher():", "nChildren", matcherXML.length);
        for (var index = 0; index < matcherXML.length; index++)
        {
			// console.log("processMatcher():", "child", index, "eltTag", parser.getElementName(matcherXML[index]));
            if (parser.getElementName(matcherXML[index]) === "matcherType")
            {
				...
				// console.log("processMatcher():", "child", index, "eltText", mType, "matcher", matcher);
            }
            ...
            if (parser.getElementName(matcherXML[index]) === "matcherParameter")
            {
				...
				// console.log("processMatcher():", "child", index, "eltAttrName", paramName, "inputMatcher", inputMatcher);
            }
        }
