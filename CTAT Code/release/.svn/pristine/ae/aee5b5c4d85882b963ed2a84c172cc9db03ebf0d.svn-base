...
//--MAX--  this.view.pageTool.redraw(this.model.body.getSelection(), pages, currentPage);
//--MAX--  this.view.propertyTool.redraw(this.model.body.getSelection(), pages, currentPage);
