...
(deftemplate studentValues (slot selection) (slot action) (slot input))

(require* logic-rule-functions "LogicTutorFunctions.clp")
(require logic-rule-functions "edu/cmu/pact/jess/LogicTutorFunctions.clp")
