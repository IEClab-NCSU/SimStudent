...
public class JCommTextFieldBeanInfo extends java.beans.SimpleBeanInfo
{

    
    public java.beans.BeanDescriptor getBeanDescriptor() {
        BeanDescriptor desc = new BeanDescriptor(JCommTextField.class);
    ...
    public java.awt.Image getIcon(int iconKind)
	{
		...
		switch (iconKind)
		{
			case ICON_COLOR_16x16:
	    		icon = loadImage("JCommTextField.gif");
				break;			
			case ICON_COLOR_32x32:
				icon = loadImage("JCommTextFieldL.gif");
			default:
				break;
		}
		return icon;
