...
public final class Numeric
{
   ...
   */
  public static String accumulate(String[] array, int first, int last,
				  String init,
				  BinaryOperator op)
    {
      String acc = init;
   ...
   */
  public static String inner_product(String[] array1, String[] array2,
   ...
   */
  public static int partial_sum(String[] source, String[] dest,
   ...
   *                  <code>to + (last - first)</code>.
   */
  public static int adjacent_difference(String[] source, String[] dest,
					int first, int last, int to,
					BinaryOperator op)
    {
      if (first < last) {
