...
public class GetSecondNumberWithSign extends GetFirstNumberWithSign 
{
    public GetSecondNumberWithSign() 
    {
		setArity(1);
		setName("second-number-with-sign");
    ...
    {    
		...
		return findSignedNum(expString, 1);
    }
