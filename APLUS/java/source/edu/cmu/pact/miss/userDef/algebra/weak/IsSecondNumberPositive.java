...
public class IsSecondNumberPositive extends IsFirstNumberPositive 
{
    public IsSecondNumberPositive() 
    {
		setArity(1);
		setName("is-second-number-positive");
    ...
    public String apply(Vector args) 
    {
		...
		String number = findSignedNum(expString, 1);
