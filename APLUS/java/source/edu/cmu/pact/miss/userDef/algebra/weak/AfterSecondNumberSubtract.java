...
public class AfterSecondNumberSubtract extends AfterFirstNumberAdd 
{
    public AfterSecondNumberSubtract() 
    {
		setArity(1);
		setName("after-second-number-subtract");
    ...
    {    
		...
		if(getOperandAfter(expString, 1) == '-')
		{
			return "T";
		}
