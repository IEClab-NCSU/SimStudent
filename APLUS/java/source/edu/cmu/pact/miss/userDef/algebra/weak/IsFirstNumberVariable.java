...
public class IsFirstNumberVariable extends EqFeaturePredicate 
{
    public IsFirstNumberVariable() 
    {
		setArity(1);
		setName("is-first-number-variable");
    ...
    public String apply(Vector args) 
    {
		...
		boolean isVariable = isNumVariable(expString, 0); 
