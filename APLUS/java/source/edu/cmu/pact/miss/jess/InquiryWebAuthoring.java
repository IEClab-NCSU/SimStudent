...
public class InquiryWebAuthoring extends InquiryClSolverTutor{
	...
	public HashMap<Sai, String> getSimStAgendaTurth() {
		return simStAgendaTurth;
	}


	public void setSimStAgendaTurth(HashMap<Sai, String> simStAgendaTurth) {
		this.simStAgendaTurth = simStAgendaTurth;
	}


	private HashMap <Sai,String> simStAgendaTurth=null;
