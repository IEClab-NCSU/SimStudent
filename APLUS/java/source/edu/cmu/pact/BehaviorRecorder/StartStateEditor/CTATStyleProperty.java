/**------------------------------------------------------------------------------------
 ...
 Revision 1.6  2011/07/19 19:54:33  vvelsen
...
*/
public class CTATStyleProperty extends CTATSerializable
{		
	/**
	 *
	 */
    public CTATStyleProperty () 
    {
    	setClassName ("CTATStyleProperty");
    	debug ("CTATStyleProperty ()");
    }
	/**
	 *
	 */
