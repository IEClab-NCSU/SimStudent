...
import edu.cmu.pact.miss.userDef.oldpredicates.CanBeSimplifiedMonomial;
import edu.cmu.pact.miss.userDef.oldpredicates.CanBeSimplifiedPolynomial;
...
public class UserDefSymbolsNoCBS implements Userpackage {

    /**
     * Creates a new <code>UserDefSymbols</code> instance.
     *
     */
    public UserDefSymbolsNoCBS() {
    }
	...
	rete.addUserfunction( new CanBeSimplifiedPolynomial() );
	rete.addUserfunction( new CanBeSimplifiedMonomial() );
