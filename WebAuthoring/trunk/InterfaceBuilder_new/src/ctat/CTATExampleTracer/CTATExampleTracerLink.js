...
/***************************** PRIVILEDGED METHODS *****************************************************/
	...
	{
		var m = this.getMatcher(); //do we evn need this anymore? we can access it directly

		this.setInterpolateSAI(sai.getSelectionAsString(), sai.getActionAsString(), sai.getInputAsString());
