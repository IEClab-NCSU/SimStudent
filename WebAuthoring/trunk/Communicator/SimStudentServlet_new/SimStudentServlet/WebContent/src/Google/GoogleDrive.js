...
function GoogleDrive()
{
        ...
        function(authResult){ 
          ...
          if(authorized)//access token retrieved, requests to API allowed
          {
            ...
            if(!immediate){
              ...
              ctatdebug("Authorization unsuccessful.");
  ...
  */
   ...
   */
   ...
   {
		ctatdebug("getFile("+fileName+")");
	
		if(!callback) callback=function(file){ctatdebug(file);}
