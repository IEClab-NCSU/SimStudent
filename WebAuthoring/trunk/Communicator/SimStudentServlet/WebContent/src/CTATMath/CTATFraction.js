 ...
 * $HeadURL: svn://pact-cvs.pact.cs.cmu.edu/usr5/local/svnroot/AuthoringTools/trunk/HTML5/src/CTATMath/CTATFraction.js $
 */
 ...
 * @param {Number|String|CTAT.Math.Fraction|null} num	The numerator.
 * @param {Number|String|null} den	The denominator.
 * @default 0,1
...
CTAT.Math.Fraction.prototype = Object.create(CTAT.Math.Fraction.prototype, {
	...
	/**
	 * @methodOf CTAT.Math.Fraction.prototype
	 * @returns {String} a string representing the MathML representation of the
	 *   fraction.
	 * @todo return a proper DOM object.
	 */
	toMathML: {
		value: function() {
			if (this.denominator == 1)
				return "<math><mn>"+this.numerator+"</mn></math>";
			else
				return "<math><mfrac><mn>"+this.numerator+"</mn><mn>"+this.denominator+"</mn></mfrac></math>";
		}
	},
	 ...
	 * @methodOf CTAT.Math.Fraction.prototype
	 * @param {Number|String|CTAT.Math.Fraction} numerator
	 ...
	 *                      @default 0
	 * @param {Number|String} denominator If {Number}, it will set the denominator to the value
