...
public class _ApplyDemorganLawOnAnd extends MyFeaturePredicate {
	private static final long serialVersionUID = 1L;
	private static PLParser parser;
	public _ApplyDemorganLawOnAnd() {
		setArity(1);
		setName("apply-demorgan-and");
	...
	public String apply(Vector args) {
		...
		System.out.println("~~~~~demorgan_And:"+result);
		return result;
	}
