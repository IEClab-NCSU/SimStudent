...
set CPATH=%DorminJar%;..;.
set VmOption=-DDebugCodes=miss,ss,rr -cp %CPATH% -Xmx512m -DssFoilBase=..\FOIL6 -DnoCtatWindow
...
REM set TutorArg=%TutorArg% -ssIntroVideo demoVideoBrief.mov
...
;;java %vmOption% SimStAlgebraV8.SimStAlgebraV8 %TutorArg% >bat_log.txt
;;pause 10

java %VmOption% SimStAlgebraV8.SimStAlgebraV8 %TutorArg% 1>bat_log.txt 2>&1
echo %ERRORLEVEL%
exit %ERRORLEVEL%