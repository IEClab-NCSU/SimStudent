...
TutorArg="-traceLevel 5 -debugCodes none"
...
TutorArg="${TutorArg} -ssQuizProblemAbstractor SimStAlgebraV8.AlgebraV8AdhocQuizProblemAbstractor"
TutorArg="${TutorArg} -ssProjectDir ."
TutorArg="${TutorArg} -ssNumBadInputRetries 2"
TutorArg="${TutorArg} -ssProblemsPerQuizSection 2"
TutorArg="${TutorArg} -ssOperatorFile operators.txt"
TutorArg="${TutorArg} -ssCLQuizReqMode"
TutorArg="${TutorArg} -Dcourse_name=simStMetaTutor"
TutorArg="${TutorArg} -Dschool_name=pilot"
TutorArg="${TutorArg} -Dunit_name=Tutoring"
