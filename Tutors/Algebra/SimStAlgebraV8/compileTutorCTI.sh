...
echo compiling AlgebraResponseSatisfactoryGetter...
echo ${JAVAC} ${VmOption} AlgebraResponseSatisfactoryGetter.java
${JAVAC} ${VmOption} SimStAlgebraV8/AlgebraResponseSatisfactoryGetter.java -source 1.8 -target 1.8
