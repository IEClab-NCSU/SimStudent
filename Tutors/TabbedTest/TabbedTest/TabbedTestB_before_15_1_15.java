...
public class TabbedTestB_before_15_1_15 extends javax.swing.JPanel implements DoneButton, TabbedTest 
{
	
	private static final long serialVersionUID = 1L;
	
	public static final String equationImage = "TabbedTest/B_eq_problems.png";
	public static final String effectiveImage = "TabbedTest/B_effective.png";
	public static final String varConstImage = "TabbedTest/B_LT_var_const.png";
	public static final String likeTermImage = "TabbedTest/B_LT_like_term.png";
	public static final String demo1Image = "TabbedTest/B_demo1.png";
	public static final String demo2Image = "TabbedTest/B_demo2.png";
	public static final String demo3Image = "TabbedTest/B_demo3.png";
	
	public TabbedTestB_before_15_1_15() {
		try {
    ...
    public static void main(String[] argv) {
    	...
    	launch.launch (new TabbedTestB_before_15_1_15());
