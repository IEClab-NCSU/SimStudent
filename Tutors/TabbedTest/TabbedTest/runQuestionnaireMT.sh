...
cmd="java ${VmOption} TabbedTest.QuestionnaireMT -traceLevel 3 -debugCodes miss log -ssProjectDirectory /Users/simstudent/Desktop/SimStudentGithub/SimStudent-master/Tutors/TabbedTest -ssLoadPrefsFile brPrefsTest.xml -ssUserID NIKOLAOS3245 -ssLocalLogging  -ssLogging -ssLogURL http://pslc-qa.andrew.cmu.edu/log/server -Dcourse_name=simstOnlineTest-TestScores -Dunit_name=Pre-Test -DnoCtatWindow -DProblemFileLocation=./questionnaireMT.brd";
${cmd};
