 ...
 * @author  mpschnei
 */
public class TabbedPreTest extends javax.swing.JPanel {
    
    /** Creates new form TutorTemplate */

    public TabbedPreTest() {
        initComponents();
    ...
    private void initComponents() {
        ...
        dorminLabel19.setImageName("$(eq_problem0)$");
        ...
        dorminLabel58.setImageName("$(LT_problem1)$");
        ...
        dorminLabel133.setImageName("$(eqexp_problem1)$");
        ...
        dorminLabel30.setImageName("$(effective_problem1)$");
        ...
        demonstration_problem1_step1.setImageName("$(demonstration_problem1)$");
        ...
        demonstration_problem2_step1.setImageName("$(demonstration_problem2)$");
        ...
        demonstration_problem3_step1.setImageName("$(demonstration_problem3)$");
        ...
        demonstration_problem4_step1.setImageName("$(demonstration_problem4)$");
        ...
        demonstration_problem5_step1.setImageName("$(demonstration_problem5)$");
    ...
    public static void main(String[] argv) {
        new CTAT_Launcher(argv).launch (new TabbedPreTest());
    }
