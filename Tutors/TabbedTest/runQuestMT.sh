...
##java ${VmOption} TabbedTestA -DProblemFileLocation="./A.brd" -DBehaviorRecorderVisible=false -Dcourse_name=SimStPilotPreTestA.brd -Dschool_name=CMU
...
cmd="java ${VmOption} TabbedTest.QuestionnaireMT -DnoCtatWindow -DProblemFileLocation=./questionnaireMT.brd";
${cmd};
