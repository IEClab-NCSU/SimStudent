...
class CTATXBlock(XBlock):
    ...
    def studio_submit(self, data, dummy_suffix=''):
        ...
        # get the valid course information:
        self.section = str(data.get('section'))
        self.subsection = str(data.get('subsection'))
