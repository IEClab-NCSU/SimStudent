...
class TextboxXBlock(XBlock, StudioEditableXBlockMixin):
    ...
    def get_status_when_refresh(self, data, suffix=''):
        return {"countTimes": self.count_times, "correctness": self.correct, "userAnswer": self.user_answer, "dynamicClicked": self.dynamicClicked}
    ...
    def update_question(self, data, suffix=''):
        ...
        self.setBorderColor = util_update_xblock_for_exporter(xblock_id, course_id, section, subsection, unit, type_of_xblock, title, question,image_url, correct_answer, hint, problem_name, skillname)
